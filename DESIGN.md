...
| 셸 | 모바일 헤더 48(브랜드 `BrandWordmark` accent 15/800 — 사이드바 18 · 로그인 28 · 우측 모노 기준일 · 가계부 pill) · 탭바 64(bg 배경 · 상단 hair · 활성 accent) · `＋ 기록` 8px 라운드 accent 버튼 40px(탭바 위 우측, 홈·거래) / 데스크톱 사이드바 220(활성 = accent-soft 배경 + accent 텍스트, 하단 "기록하기") |
