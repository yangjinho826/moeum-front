...
## 남은 보류(배포 막지 않음)
- 배치5 H-503~H-507 (H-501 수정에서 비우기 = 사용자 결정으로 닫음 — 백엔드 변경 안 함)
- 배치6 H-602(내보내기·멤버 시점 실데이터) · H-603 · H-604 · H-605(가입 재오픈) (H-601 아이콘 칸 폭 ✅ 22142d6)
- 배치7 H-702(온보딩 중 셸) · H-703(온보딩 렌더) · H-704 (H-701 현재가 0 수정 ✅ 6e16c34)
